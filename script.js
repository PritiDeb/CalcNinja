...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function startGame(gameType) {
    ...
    document.getElementById(`${gameType}-scores`).style.display = "none"; // HIDE high scores during gameplay
  ...
  function endGame(gameType) {
    ...
    document.getElementById(`${gameType}-scores`).style.display = "block"; // SHOW high scores when returning to main menu
  }
